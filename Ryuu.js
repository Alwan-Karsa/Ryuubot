...
Badmin: 'Bot Harus Jadi Admin Kalo Mau Menggunakan Fiturnya', 
        ...
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `Made By ${ownername}`, orderTitle: 'Ryuukaa', sellerJid: '0@s.whatsapp.net'} } }
//═════════[ VERIFY ]══════════/
//═════════[ Button ]══════════//
...
📦 𝙂𝙧𝙤𝙪𝙥 :
https://chat.whatsapp.com/KYFdPsjHKIr5ToVIqOAunE
